...
const publicPath = path.resolve(__dirname, 'src', 'resources', 'static');
const nodeModulesPath = path.resolve(__dirname, 'node_modules');
const appPath = path.resolve(__dirname, 'src', 'resources', 'client', 'App.js');
...
module.exports = {
  ...
  plugins: [
    new HtmlWebpackPlugin({ // Iterate this plugind and excludeChunks for new page templates.
      ...
      favicon: path.resolve(__dirname, 'src', 'resources', 'client', 'image', 'favicon.ico'),
